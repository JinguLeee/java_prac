...
class Exercise5_1 {
    public static void main(String[] args) {
//        int[] arr[];
//        int[] arr = {1,2,3,};                 // 왜 되는지 모르겠음
//        int[] arr = new int[5];
//        int[] arr = new int[5]{1,2,3,4,5};    // [5]가 []이거나 배열을 선언 후 초기화 해야한다.
//        int arr[5];                           // 배열 선언시 new로 선언해야함
//        int[] arr[] = new int[3][];           // 순서
    }
}
    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i < words.length; i++) {
            ...
            for(int j = 0; j < question.length; j++){
                int random = (int)(Math.random() * (question.length - 1) + 1);
                char tmp = question[0];
